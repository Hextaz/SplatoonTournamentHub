const fs = require('fs');
const content = `import { supabase } from "@/lib/supabaseClient";
...
fs.writeFileSync('C:/Users/Hextaz/Documents/GitHub/tournament-bot/SplatoonTournamentHub/web/src/app/admin/[guildId]/tournaments/[id]/page.tsx', content);
